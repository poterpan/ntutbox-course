...
function bundleWith(courses: unknown[]): TermBundle {
  return {
    termKey: "115-1",
    catalog: { schema_version: 2, term: { key: "115-1", year: 115, semester: 1, label: "" }, generated_at: null, source: {} as never, freshness: {}, courses } as never,
    ...
    classes: { schema_version: 2, term_key: "115-1", classes: [] } as never,
    enrollment: null,
  };
}
