...
- **結果統計（43 碼位）**：
  - **41 碼位高信心已認字**（含 6 個既有對照，GServer 字形與既有認定完全吻合）；
  - **1 碼位需人工裁決**：`U+E0E1`（勳／勲 日式異體之辨，見 §4.1）；
  - **1 碼位無字形**：`U+EF0D`（cmap 有碼位但 glyf 無輪廓，非實際造字，見 §4.2）。

- **入庫**：本 PR 於 `PUA_MAP` 新增 **35 筆**（41 減既有 6）；`E0E1`／`EF0D` 不入表，維持「未收錄一律原樣保留（不猜、不刪）」原則。
...
| `U+E031` | 涂 (U+6D82) | high | 課綱課號 [366510](https://aps.ntut.edu.tw/course/tw/ShowSyllabus.jsp?snum=366510&code=11172)：…方位按摩法 作者： 涂俐雯 追蹤作者…；課綱課號 [366517](https://aps.ntut.edu.tw/course/tw/ShowSyllabus.jsp?snum=366517&code=11172)：…方位按摩法 作者： 涂俐雯 追蹤作者… | 本 PR 新增 PUA_MAP |
...
| `U+E0E1` | 勲／勳（待裁決） | medium | 教師 [王柏◻](https://aps.ntut.edu.tw/course/tw/Teach.jsp?format=-3&year=113&sem=1&code=24593)（113-1） | **不入表**（待人工，見 §4.1） |
...
| `U+E10D` | 昔 (U+6614) | high | 課綱課號 [362380](https://aps.ntut.edu.tw/course/tw/ShowSyllabus.jsp?snum=362380&code=11108)：…acids (核昔酸與核酸） Ch.… | 本 PR 新增 PUA_MAP |
...
### 4.1 `U+E0E1` — 勳 vs 勲（待使用者裁決）

GServer 字形上部與 `U+E0B2`（勳）同族但略異，最可能為 **勲**（U+52F2，日式異體），與勳（U+52F3）僅上半部件差異。出處：教師 王柏◻（管院《自媒體行銷學》，[https://aps.ntut.edu.tw/course/tw/Teach.jsp?format=-3&year=113&sem=1&code=24593](https://aps.ntut.edu.tw/course/tw/Teach.jsp?format=-3&year=113&sem=1&code=24593)）。字形放大並排見下圖，**在使用者裁決前不入 `PUA_MAP`**。
