...
| 項目 | 門檻 | 規則 (a)(b)(c) | 加 (d)(e) 後 |
|---|---|---|---|
| `resolved_lookup_cell_rate` | ≥ **0.4725**（不得下降） | 0.5004 | **0.5561** |
| `schedule_parse_coverage` | ≥ **0.5697**（不得下降） | 0.5742 | **0.6291** |
...
**開課實例層級的實際涵蓋率**（115-1，2026-09-14 資料，2,725 個開課實例）：

| | (a)(b)(c) | 加 (d)(e) |
|---|---:|---:|
| 能顯示至少一週 | 1,192（43.7%） | **1,307（48.0%）** |
| 能排滿 1–16 週 | 940（34.5%） | **1,056（38.8%）** |
| 隨機（課, 週）可顯示 | 38.2% | **42.4%** |

仍為 0 週的 1,418 門中，**789 門根本沒有 syllabus**（占全部的 29.0%）——那是天花板。
